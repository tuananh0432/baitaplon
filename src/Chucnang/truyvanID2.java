 ...
 * @author ASUS
 */
public class truyvanID2 extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(ID6, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Xem))
                .addGap(155, 155, 155))
        );
    ...
    private void XemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XemActionPerformed
        Xemthongtin2 xemthongtin2 = new Xemthongtin2();
        try {
            

               String ID5= ID6.getText();
            if (Xemthongtin2.isLogin(ID5,this))
                {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(truyvanID2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
